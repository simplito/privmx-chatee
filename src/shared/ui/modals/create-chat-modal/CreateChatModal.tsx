...
import useThreadCreate from '@/lib/hooks/useThreadCreate';
...
export function CreateChatModal({ context, id }: ContextModalProps<{}>) {
                    ...
                    <form
                        ...
                        onSubmit={async (e) => {
                            ...
                            if (name && selectedCheckboxes.length >= 2) {
                                await createThread(contextId, selectedCheckboxes, name);
                            }
                        }}>
